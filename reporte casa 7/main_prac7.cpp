...
//*************				HERNANDEZ HINOJOSA ERNESTO
			//                  ACTIVIDAD DE de lab PRACTICA 7                ******//
...
GLfloat NepDiffuse[] = { 0.25f, 0.8f, 0.7f, 1.0f };			
