...
//*************				HERNANDEZ HINOJOSA ERNESTO
            //                  ACTIVIDAD DE de casa PRACTICA 5                  ******//
//*************			SE IMPLEMENTO DESDE VISUAL STUDIO 2017			******//
//teclas para activar mov  h,j,x,t minusculas y mayus//
//************************************************************//
#include "Main.h"
float angleY;
float angleX;
...
//				 glPopMatrix();
 ...
 //cuello
												...
												//cabeza
																...
																glTranslatef(-0.5, 0.5, 0); // muevo mis cordenandas ya no es el 0.0 -2.5,1.25
																glScalef(0.16, 0.16, 0.19);
														...
														///////////////////////dedos
																...
																glRotatef(180, 0, 1, 0);
																glPushMatrix();//dibuja brazo
glTranslatef(0, 0.5, 0); // muevo mis cordenandas ya no es el 0.0 -2.5,1.25
glScalef(0.16, 0.16, 0.19);
