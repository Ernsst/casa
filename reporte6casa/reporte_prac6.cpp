...
//*************				HERNANDEZ HINOJOSA ERNESTO
			//                  ACTIVIDAD DE de casa PRACTICA 6                  ******//
...
//atomo
	...
	glColor3f( 1.,1,0 );
	glutSolidSphere(1.9,20,20);  //proton esfera
   ...
   // glColor3f(0.25, 0.41, 0.88);
	...
	glPushMatrix();
	glRotatef(150,0,0,1);
	glRotatef(electron8,0,1,0);
    glTranslatef(5,0,0);
    glColor3f(0.1, 0.75, 0.4);
   // glColor3f(0.25, 0.41, 0.88);
	glutSolidSphere(0.3, 20, 20);
	glPopMatrix();
...
void animacion()
{
	...
	if(dwElapsedTime >= 30)
	{
		...
		electron2 =(electron2 -2)%360;
		electron3 =(electron3 +3)%360;
		electron4 =(electron4 -4)%360;
		electron5 =(electron5 +5)%360;
		electron6 =(electron6 -4)%360;
        electron7 =(electron7 +3)%360;
		electron8 =(electron8 -2)%360;
