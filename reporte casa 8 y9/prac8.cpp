...
//************************************************************//
//************************************************************//
//************** Alumno (s): actividad casa practica 8y 9 *********************************//
//*************		Hernandez Hinojosa Ernesto			******//
//*************		Se implementó en visual studio 2017	******//


//****elementos transparentes tanto en la silla como en la mesa*//
//************************************************************//
#include "texture.h"
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPopMatrix();
					glPushMatrix();
						...
						glScalef(4.0, 1.0, 0.8);
						//glRotatef(-90, 0, 1, 0);
						prisma(t_pino.GLindex, t_pino.GLindex);
	...
	glRotatef(-90, 0, 1, 0);
	prisma(t_metal01.GLindex, t_Ajedrez1.GLindex);

	glPushMatrix();  //patass
	glTranslatef(0.6, -1.5, 0.8);
	...
	glScalef(3.2, 1.0, 0.8);
	//glRotatef(-90, 0, 1, 0);
	prisma(t_pino.GLindex, t_pino.GLindex);

	glPushMatrix();
	glColor3f(1.0, 1.0, 1.0);
	glTranslatef(0, 0, 6); //cerca lejos asiento 
	//glRotatef(-90, 0, 1, 0);
	prisma(t_pino.GLindex, t_pino.GLindex);
	glPopMatrix();
	glPopMatrix();

	glPushMatrix();   ///asiento frente 
	glColor3f(1.0, 1.0, 1.0);
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("actividad casa práctica 8y9"); // Nombre de la Ventana
